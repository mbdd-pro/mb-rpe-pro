Router.register('coach', async()=>{
  ...
  setPageContent(`
    ...
    <div class="grid2"><button class="btn" onclick="Router.go('coach-sessions')">Crear / ver sesiones</button><button class="btn secondary" onclick="Api.invalidate(); Router.render()">Actualizar datos</button></div>
