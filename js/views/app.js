...
function syncNow(){
  ...
  const byRoute = {
    coach:['coachDashboard','teamWellnessOverview'],
    'coach-graphs':['teamLoadOverview'],
    'coach-sessions':['listSessions','sessionDetail'],
    'coach-players':['listPlayers','playerDetail'],
    'coach-compare':['comparePlayers','listPlayers'],
    athlete:['athleteHome','athleteWellness'],
    'athlete-sessions':['athleteHome'],
    'athlete-stats':['athleteStats','athleteLoadMetrics'],
    profile:['playerDetail']
  };
  Api.invalidateMany((byRoute && byRoute[r.name]) || []);
  toast('Sincronizando...');
  Router.render();
}
